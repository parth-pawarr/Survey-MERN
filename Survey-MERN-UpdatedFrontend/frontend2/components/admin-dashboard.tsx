...
import { LogOut, Loader2, Users, MapPin, BarChart3, TrendingUp, Settings } from "lucide-react";
      ...
      <main className="mx-auto max-w-6xl p-4">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="mb-4">
            <TabsTrigger value="management" className="flex items-center gap-1.5 text-xs">
          ...
          <TabsContent value="management" className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base flex items-center gap-2">
                    <Users className="h-4 w-4" /> Surveyors
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base flex items-center gap-2">
                    <MapPin className="h-4 w-4" /> Villages
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base flex items-center gap-2">
                    <BarChart3 className="h-4 w-4" /> Active Surveyors
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">{surveyors.filter(s => s.isActive).length}</div>
          ...
          <TabsContent value="analytics">
            <SurveyAnalyticsDashboard onClose={() => setActiveTab("management")} />
          </TabsContent>
        </Tabs>
      </main>
    </div>
